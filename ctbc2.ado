...
*! 示例
*! ctbc2
*! line rate0d rate1m rate2m rate3m rate6m rate9m rate1y rate2y rate3y rate4y rate5y rate6y rate7y rate8y rate9y rate10y rate15y rate20y rate30y rate40y rate50y date, ///
*! 	xlabel(,ang(20)) xti("日期") yti("国债到期收益率(%)") ///
*! 	yla(0(2)10) leg(col(3) pos(11) ring(0))
*! gre ctbc2
cap prog drop ctbc2
prog def ctbc2
	version 14.0
